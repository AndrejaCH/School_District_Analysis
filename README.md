...
Python’s Library **Pandas** is very flexible and easy to manipulate. There are a lot of information about Pandas on the web. For example, [Pandas User Guide - official documentation](https://pandas.pydata.org/docs/user_guide/index.html#user-guide). On the link below, I have included Pandas commands that I used in this analysis.
